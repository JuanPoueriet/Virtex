...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TabView_t::offsetsAndSizes) + ofs), len
Q_CONSTINIT static const qt_meta_stringdata_TabView_t qt_meta_stringdata_TabView = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_TabView[] = {
...
Q_CONSTINIT const QMetaObject TabView::staticMetaObject = { {
    ...
    qt_meta_stringdata_TabView.offsetsAndSizes,
    qt_meta_data_TabView,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TabView_t,
        // Q_OBJECT / Q_GADGET
